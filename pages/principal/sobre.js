	...
	CorpoElementoMutavel.innerHTML = `
		<div class="topo flex-topo">
			...
			<nav class="menu flex-topo">
		        ...
		        <li id="mutavel"><a id="MenuAnuncios" href="#" onclick="SobreSelecionado()">Sobre</a></li>
		        <li><a id="MenuProjetos" href="#" onclick="ContatoSelecionado()">Contato</a></li>
